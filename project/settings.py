...
SECRET_KEY = 'django-insecure--t59e0kvk+whhov6cqqrrbssklo%18p%%m8fy#!7x24-8lss^$'
...
DATABASES = { # added this to use postgres as the database instead of the default sqlite. do this before running the initial migrations or you will need to do it again
    # Changing the original django database to this via his lesson - set up to use postgres
    'default': {
