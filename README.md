...
27. In comments folder, in views.py, put this:
...
28. We don't have the serializer created yet, so need to create that next.
- If not already created, create a serializer.py file and add the following code to this:
...
from .models import Comment
from .serializers import CommentSerializer #ADD THIS LINE IF DON'T HAVE
